  ...
  return (
    <div className="flex m-3 px-3 py-6  rounded-lg bg-white">
      <div className="flex flex-col gap-3 ">
        ...
        <input
          type="text"
          placeholder="2.Do this"
          className="w-1/2 border p-2"
        />
        <input
          type="text"
          placeholder="3.Do this"
          className="w-1/2 border p-2"
        />
        <p>
        ...
        />
        <p>
          What are the three big milestones that if you hit would make next week
          a win for you?
        </p>
        <input
          type="text"
        ...
        />
        <p>
          What might prevent you from achieving these milestones and what can
